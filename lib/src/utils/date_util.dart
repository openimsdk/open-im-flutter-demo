...
class DateUtil {
  ...
  static String getCallTime(int milliseconds) {
    if (yearIsEqualByMillis(milliseconds, getNowDateMs())) {
      return formatDateMs(milliseconds, format: 'MM月dd');
    } else {
      return formatDateMs(milliseconds, format: 'yyyy月MM月dd');
    }
  }

  static String getCallDuration(int seconds) {
    var d = Duration(seconds: seconds);
    return '${d.inHours}时${d.inMinutes}分${d.inSeconds}秒';
  }

  static String getCallDuration2(int seconds) {
    var d = Duration(seconds: seconds);
    var hours = d.inHours > 10 ? d.inHours : '0${d.inHours}';
    var minute = d.inMinutes > 10 ? d.inMinutes : '0${d.inMinutes}';
    var sec = d.inSeconds > 10 ? d.inSeconds : '0${d.inSeconds}';
