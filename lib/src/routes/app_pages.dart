...
import 'package:openim_enterprise_chat/src/pages/add_friend/accept_friend_request/accept_friend_request_binding.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/accept_friend_request/accept_friend_request_view.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/add_friend_binding.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/add_friend_view.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/search/search_binding.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/search/search_view.dart';
import 'package:openim_enterprise_chat/src/pages/add_friend/send_friend_request/send_friend_request_binding.dart';
...
import 'package:openim_enterprise_chat/src/pages/chat/chat_setup/create_group/create_group_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/chat_setup/create_group/create_group_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/chat_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/announcement_setup/announcement_setup_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/announcement_setup/announcement_setup_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/group_member_manager_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/group_member_manager_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/member_list/member_list_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/member_list/member_list_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/search_member/search_member_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_member_manager/search_member/search_member_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_setup_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/group_setup_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/id/id_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/id/id_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/my_group_nickname/my_group_nickname_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/my_group_nickname/my_group_nickname_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/name_setup/name_setup_binding.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/name_setup/name_setup_view.dart';
import 'package:openim_enterprise_chat/src/pages/chat/group_setup/qrcode/qrcode_binding.dart';
...
import 'package:openim_enterprise_chat/src/pages/contacts/friend_info/id_code/id_code_view.dart';
import 'package:openim_enterprise_chat/src/pages/contacts/friend_info/remark/remark_binding.dart';
import 'package:openim_enterprise_chat/src/pages/contacts/friend_info/remark/remark_view.dart';
import 'package:openim_enterprise_chat/src/pages/contacts/friend_list/friend_list_binding.dart';
...
import 'package:openim_enterprise_chat/src/pages/contacts/group_list/search_group/search_group_view.dart';
import 'package:openim_enterprise_chat/src/pages/contacts/join_group/join_group_binding.dart';
...
import 'package:openim_enterprise_chat/src/pages/login/login_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/about_us/about_us_binding.dart';
import 'package:openim_enterprise_chat/src/pages/mine/about_us/about_us_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/account_setup/account_setup_binding.dart';
import 'package:openim_enterprise_chat/src/pages/mine/account_setup/account_setup_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/add_my_method/add_my_method_binding.dart';
import 'package:openim_enterprise_chat/src/pages/mine/add_my_method/add_my_method_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/blacklist/blacklist_binding.dart';
import 'package:openim_enterprise_chat/src/pages/mine/blacklist/blacklist_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/my_id/my_id_binding.dart';
import 'package:openim_enterprise_chat/src/pages/mine/my_id/my_id_view.dart';
import 'package:openim_enterprise_chat/src/pages/mine/my_info/my_info_binding.dart';
...
import 'package:openim_enterprise_chat/src/pages/register/setupinfo/setupinfo_view.dart';
import 'package:openim_enterprise_chat/src/pages/register/setuppwd/setuppwd_binding.dart';
import 'package:openim_enterprise_chat/src/pages/register/setuppwd/setuppwd_view.dart';
import 'package:openim_enterprise_chat/src/pages/register/verifyphone/verifyphone_binding.dart';
import 'package:openim_enterprise_chat/src/pages/register/verifyphone/verifyphone_view.dart';
import 'package:openim_enterprise_chat/src/pages/select_contacts/group_member/group_member_binding.dart';
import 'package:openim_enterprise_chat/src/pages/select_contacts/group_member/group_member_view.dart';
import 'package:openim_enterprise_chat/src/pages/select_contacts/select_contacts_binding.dart';
import 'package:openim_enterprise_chat/src/pages/select_contacts/select_contacts_view.dart';
import 'package:openim_enterprise_chat/src/pages/splash/splash_binding.dart';
import 'package:openim_enterprise_chat/src/pages/splash/splash_view.dart';
